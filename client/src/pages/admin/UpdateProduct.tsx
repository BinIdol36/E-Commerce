import { Button, InputForm, MarkdownEdit, Select, Loading } from "@/components"
...
const UpdateProduct = ({ editProduct, render, setEditProduct }) => {
  ...
  return (
    <div className="w-full flex flex-col gap-4 relative">
      ...
      <div className="p-4 border-b flex bg-gray-100 justify-between items-center fixed left-[327px] top-0 right-0">
      ...
      <div className="p-4">
        <form onSubmit={handleSubmit(handleUpdateProduct)}>
          ...
          <div className="flex flex-col gap-2 mt-8">
            ...
            <input type="file" id="prodcuts" multiple {...register("images")} />
            {errors["images"] && (
              <small className="text-xs text-red-500">
